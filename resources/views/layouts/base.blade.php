                                    ...
                                    @if(Auth::user()->utype === 'ADM')
                                        ...
                                        <li class="menu-item menu-item-has-children parent" >
                                            ...
                                            <ul class="submenu curency" >
                                                ...
                                                <li class="menu-item">
                                                    <a title="Manage Home Slider" href="{{route('admin.homeslider')}}">Slider
                                                        for Home</a>
                                                </li>
                                                <li class="menu-item">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                        <div class="wrap-footer-item">
                            <h3 class="item-header">HA NOI</h3>
                            <div class="item-content">
                                <div class="wrap-contact-detail">
                                    <ul>
                                        <li>
                                            <i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <p class="contact-txt">2 Pham Van Bach street – Yen Hoa - Cau
                                                Giay</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-phone" aria-hidden="true"></i>
                                            <p class="contact-txt">024.7300.2266</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-envelope" aria-hidden="true"></i>
                                            <p class="contact-txt">GWEHaNoi@greenwich.vn</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                        <div class="wrap-footer-item">
                            <h3 class="item-header">DA NANG</h3>
                            <div class="item-content">
                                <div class="wrap-contact-detail">
                                    <ul>
                                        <li>
                                            <i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <p class="contact-txt">658 Ngo Quyen street - Son Tra district - Da Nang
                                                City</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-phone" aria-hidden="true"></i>
                                            <p class="contact-txt">0236.730.2266</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-envelope" aria-hidden="true"></i>
                                            <p class="contact-txt">GWEDaNang@greenwich.vn</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                        <div class="wrap-footer-item">
                            <h3 class="item-header">HO CHI MINH</h3>
                            <div class="item-content">
                                <div class="wrap-contact-detail">
                                    <ul>
                                        <li>
                                            <i class="fa fa-map-marker" aria-hidden="true"></i>
                                            <p class="contact-txt">20 Cong Hoa street – 12 ward – Tan Binh district</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-phone" aria-hidden="true"></i>
                                            <p class="contact-txt">028.7300.2266</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-envelope" aria-hidden="true"></i>
                                            <p class="contact-txt">GWEHoChiMinh@greenwich.vn</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="wrap-footer-item">
                            ...
                            <div class="item-content">
                                <div class="wrap-hotline-footer">
                                    ...
                                    <b class="phone-number">0933.108.554 | 0971.294.545</b>
                                </div>
                            </div>
                        </div>
        ...
        <div class="coppy-right-box">
            <div class="container">
                <div class="coppy-right-item item-left">
                    <p class="coppy-right-text">Copyright © 2021 Qavi Education. All rights reserved</p>
                </div>
                <div class="coppy-right-item item-right">
                    <div class="wrap-nav horizontal-nav">
                        <ul>
                            <li class="menu-item"><a href="https://www.facebook.com/Vinh.Coi.1010/" target="_blank"
                                                     class="link-term">About Me</a></li>
