                    ...
                    <div class="order-summary">
                        ...
                        @if(Session::has('coupon'))
                            ...
                            <p class="summary-info"><span class="title">Tax ({{config('cart.tag')}}2%)<a target="_blank"
                                        href="https://www.expatica.com/uk/finance/taxes/a-complete-guide-to-the-uk-tax-system-758254/#:~:text=Tax%20is%20charged%20on%20total,on%20incomes%20over%20%C2%A3125%2C000./"><i class="fa fa-file" aria-hidden="true"></i></a></span><b
