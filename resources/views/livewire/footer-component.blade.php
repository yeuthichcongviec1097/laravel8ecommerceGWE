        ...
        <div class="main-footer-content">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <center>
                        <div class="wrap-map">
                            <iframe src="{{$setting->map}}" width="600" height="320" style="border:0; padding: 30px;" allowfullscreen="" loading="lazy"></iframe>
                        </div>
                    </center>
                        ...
                        <div class="wrap-footer-item">
                            ...
                            <div class="item-content">
                                <div class="wrap-list-item social-network">
                                    <ul>
                                        <li><a href="{{$setting->twitter}}" class="link-to-item" title="twitter"><i class="fa fa-twitter"
                                                                                                aria-hidden="true"></i></a>
                                        </li>
                                        <li><a href="{{$setting->facebook}}" class="link-to-item" title="facebook"><i class="fa fa-facebook"
                                                                                                 aria-hidden="true"></i></a>
                                        </li>
