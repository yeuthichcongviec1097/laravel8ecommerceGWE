                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($order->status == 'ordered')
                                    <a href="#" class="btn btn-warning pull-right" style="margin-right: 20px;" wire:click.prevent="cancelOrder">Cancel</a>
                                @endif
                            </div>
                        </div>
                    </div>
                                ...
                                @foreach($order->orderItems as $item)
                                    <li class="pr-cart-item">
                                        ...
                                        @if($order->status == 'delivered' && $item->rstatus == false)
                                            <div class="price-field sub-total"><p class="price"><a href="{{route('user.review', ['order_item_id' => $item->id])}}" class="btn btn-info text-center">Write Review</a></p></div>
                                        @endif
                                    </li>
                                @endforeach
                            </ul>
